...
$config['mongo_db']['default']['hostname'] = 'sql.fuad.net';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'ci_fuad';
$config['mongo_db']['default']['password'] = 'y3byxfi403&$44wWkzKv';
$config['mongo_db']['default']['database'] = 'ci_fuad';

...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?=url().'login'?>" method="post">
    		<?=isset($errors['system'])? $errors['system'] : ''?>
          ...
          <div class="row">
            <div class="col-xs-4">
              <a href="http://lsp.stiki.ac.id" class="btn btn-success btn-block btn-flat"><i class="fa fa-home"></i> Home</a>
            </div>
						<div class="col-xs-4">
						</div>
            <!-- /.col -->

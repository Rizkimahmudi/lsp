...
<section class="content">
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class="row">
				<form method="post" action="<?=url('penjadwalan/search')?>" class="form-horizontal">
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						...
						<div class="pull-right text-center">
							...
							<a href="<?=url().'penjadwalan/'?>" class="btn btn-default btn-sm"><i class="fa fa-list-alt"></i> Show All</a>
							<a href="<?=url('penjadwalan/add')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Jadwal</a>
						</div>
					</div>
				</form>
			</div>
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content" >
      <div class="modal-header">
        ...
        <h4 class="modal-title">Jadwal Detail</h4>
      </div>
...
<div class="modal fade" id="modal-absensi" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document" >
    <div class="modal-content" >
      ...
      <div class="modal-body rekapAbsensi">
      </div>
	  <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>

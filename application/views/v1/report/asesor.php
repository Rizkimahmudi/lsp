...
<section class="content">
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class="row">
				<form method="post" action="<?=url('report/asesor/search')?>" class="form-horizontal">
					<input type="hidden" name="route" value="asesor">
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="pull-right text-center">
							...
							<a href="<?=url().'report/asesor/'?>" class="btn btn-default btn-sm"><i class="fa fa-list-alt"></i> Show All</a>
							<a href="<?=url('report/asesor/', array_merge($param, ['export' => 1]))?>" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Export</a>
						</div>
					</div>
				</form>
			</div>
